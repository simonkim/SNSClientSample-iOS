...
{
    static NSString *CellIdentifier = @"cell_twitter_account";
...
{
    [self.delegate accountsViewController:self didSelectAccount:[self.accounts objectAtIndex:indexPath.row]];
}
